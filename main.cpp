...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        while (player2.currentBet < player1.currentBet) {
            cout << player2.name << " you must bet at least: " << player1.currentBet << endl;
            cin >> player2.currentBet;
            cin.ignore();
        }
        ...
        while (player1.currentBet != player2.currentBet) { //Cannot move on to next round until everyone has bet the same amount
            ...
            if (player1.currentBet < player2.currentBet) { //This checks to see who needs to match who. In this case player1 has not bet enough to match player 2.
                ...
                if (count == 1) {
                    cout << player2.name << " bet " << player2.currentBet - tempBet1<<". "<<player1.name <<" you must bet at least that much" << endl;
                }
                else {
                    cout << player2.name << " bet " << tempBet1 <<". "<<player1.name <<" you must bet at least that much" << endl;
                }
                
                cout << player1.name << " if you would like to see your total money press m" << endl; // Allows player to see how much money they have
                cin >> answer;
                cin.ignore();
                if (answer == "m") {
                ...
                cin >> tempBet1;
                cin.ignore();
                if (player1.currentBet == -1) { //Fold check
                    player1.fold = true;
                    break;
                }
            ...
            if (player2.currentBet < player1.currentBet) { // This is the same as the previous if statement except for player2
                if (count == 1) {
                    cout << player1.name << " bet " << player1.currentBet - tempBet2<<". "<<player2.name <<" you must bet at least that much" << endl;
                }
                else {
                    cout << player1.name << " bet " << tempBet2 <<". "<<player2.name <<" you must bet at least that much" << endl;
                }
                cout << player2.name << " if you would like to see your total money press m" << endl;
                cin >> answer;
                cin.ignore();
                if (answer == "m") {
                    cout << "you have " << player2.money << endl;
                }
                cin >> tempBet2;
                cin.ignore();
    ...
    cout << newPokerGame.showHave(player1) << endl; //This method simply returns what they have. For example, it might return "TWO OF A KIND", depending on what this player has.
    cout << newPokerGame.showHave(player2) << endl;
